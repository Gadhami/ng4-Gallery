(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('photoswipe'), require('photoswipe/dist/photoswipe-ui-default'), require('@angular/common'), require('videogular2/core'), require('videogular2/controls'), require('videogular2/overlay-play'), require('videogular2/buffering')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', 'photoswipe', 'photoswipe/dist/photoswipe-ui-default', '@angular/common', 'videogular2/core', 'videogular2/controls', 'videogular2/overlay-play', 'videogular2/buffering'], factory) :
	(factory((global['ng4-gallery'] = {}),global.ng.core,global.Rx,global.photoswipe,global.photoswipe,global.ng.common,global.videogular2,global.videogular2,global.videogular2,global.videogular2));
}(this, (function (exports,core,Subject,PhotoSwipe,PhotoSwipeUI_Default,common,core$1,controls,overlayPlay,buffering) { 'use strict';

PhotoSwipe = PhotoSwipe && PhotoSwipe.hasOwnProperty('default') ? PhotoSwipe['default'] : PhotoSwipe;
PhotoSwipeUI_Default = PhotoSwipeUI_Default && PhotoSwipeUI_Default.hasOwnProperty('default') ? PhotoSwipeUI_Default['default'] : PhotoSwipeUI_Default;

var NotificationService = (function () {
    function NotificationService() {
        this.slideshowOpenedSource = new Subject.Subject();
        this.moreItemsRequestedSource = new Subject.Subject();
        this.favoriteToggledSource = new Subject.Subject();
...
GalleryComponent.propDecorators = {
    ...
    'isSideBar': [{ type: core.Input },],
    'galleryDescr': [{ type: core.Input },],
    'mainGalleryId': [{ type: core.Input },],
    'disableLoadMoreAfter': [{ type: core.Input },],
    'scrollMoreDiv': [{ type: core.ViewChild, args: ['scrollMore',] },],
};
// Import PhotoSwipe
...
SlideShowComponent.propDecorators = {
    'photoSwipe': [{ type: core.ViewChild, args: ['slideShow',] },],
...
//# sourceMappingURL=ng4-gallery.umd.js.map
